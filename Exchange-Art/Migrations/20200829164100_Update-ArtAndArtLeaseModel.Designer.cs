...
namespace Exchange_Art.Migrations
{
    ...
    [Migration("20200829164100_Update-ArtAndArtLeaseModel")]
    partial class UpdateArtAndArtLeaseModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Exchange_Art.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("EtheruemAddress")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Exchange_Art.Models.Art", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Exchange_Art.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
